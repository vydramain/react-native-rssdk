...
public class JniRsSdkWrapper {
    private static final String TAG = JniRsSdkWrapper.class.getSimpleName();

    static {
        try {
            System.loadLibrary("SDKWrapper");
            Log.d(TAG, "SDKWrapper library loaded with success");
        } catch (UnsatisfiedLinkError e) {
            Log.d(TAG, "Can't load SDKWrapper library: " + e);
        }
    }

    private final List<String> onlineInfo = new ArrayList<String>();

    public static void search_device_callback(String param, Object user_param) {
        Log.d(TAG, "Called static search_device_callback");
        ((JniRsSdkCallback) user_param).search_device_callback(param);

    }

    public static void connction_callback(String param, Object user_param) {
        Log.d(TAG, "Called static connction_callback");
        ((JniRsSdkCallback) user_param).connction_callback(param);
    }

    public static void alarm_callback(String alarm_type, String param, Object user_param) {
        Log.e(TAG, "alarm_callback: " + alarm_type);
        ((JniRsSdkCallback) user_param).alarm_callback(alarm_type, param);

    }

    public static void preview_callback(String param, Object user_param) {
        Log.d(TAG, "Called static preview_callback");
        ((JniRsSdkCallback) user_param).preview_callback(param);
    }

    public static void search_record_month_callback(String param, Object user_param) {
        Log.e(TAG, "search_record_month_callback: " + param);
        ((JniRsSdkCallback) user_param).search_record_month_callback(param);

    }

    public static void search_record_day_callback(String param, Object user_param) {
        Log.e(TAG, "search_record_day_callback: " + param);
        ((JniRsSdkCallback) user_param).search_record_day_callback(param);

    }

    public static void download_callback_by_file(String param, Object user_param) {
        Log.e(TAG, "download_callback_by_file: " + param);
    }

    public static void download_callback_by_time(String param, Object user_param) {
        Log.e(TAG, "download_callback_by_time: " + param);
    }

    public static void playback_callback_local(String param, Object user_param) {
        Log.e(TAG, "playback_callback_local: " + param);
    }

    public static void playback_callback_remote(String param, Object user_param) {
        Log.e(TAG, "playback_callback_remote: " + param);
    }

    public static void remote_test_callback(int type, String param, Object user_param) {
        Log.e(TAG, "remote_test_callback: " + param);
    }

    public static void talk_callback(String param, Object user_param) {
        Log.e(TAG, "talk_callback: " + param);
    }

    public static void playback_thumbnails_callback(String param, Object user_param) {
        Log.e(TAG, "playback_thumbnails_callback: " + param);
    }

    public static void local_thumbnails_callback(byte[] data, Object user_param) {
        Log.e(TAG, "local_thumbnails_callback: ");
    }

    public static void log_sink_callback(String param, Object user_param) {
        Log.e(TAG, "log_sink_callback: " + param);
    }
    ...
    public static void zoom_callback(String param, Object user_param) {
        Log.e(TAG, "==========zoom_callback=========>>  ");
    }
    ...
    public native static int rs_android_surface_set_user_param(long surface_id, Object user_param);

    public native static int rs_sdk_wrapper_init(String param);

    public native static int rs_sdk_wrapper_uninit(String param);
    ...
    public native static int rs_device_login_ex(long dev, String param, Object user_param);
    ...
    public native static int rs_delete_playback_thumbnails(long sess, String param);
