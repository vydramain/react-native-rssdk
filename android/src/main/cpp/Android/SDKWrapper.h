...
#define JNI_HELP_CLASS        "com/monitoring/optimus/rs/jni/JniRsSdkWrapper"
#define JNI_FUNCTION(NAME)    Java_com_monitoring_optimus_rs_jni_JniRsSdkWrapper_##NAME
...
JNI_INT_RETURN JNI_FUNCTION(rs_1send_1simple_1command)(JNI_DEFAULT_PARAM,jlong dev,jint main_msg,jint sub_msg, jstring param);
